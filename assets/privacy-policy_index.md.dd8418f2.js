...
const i = JSON.parse('{"title":"隐私政策","description":"温馨提示
 
欢迎您使用泡泡战士冒险！我们非常重视保护您的个人信息和隐私。您可以通过《泡泡战士冒险隐私政策》了解我们收集、使用、存储用户个人信息的情况，以及您所享有的相关权利。请您仔细阅读并充分理解相关内容：
1.为向您提供游戏服务，我们将依据《泡泡战士冒险隐私政策》收集、使用、存储必要的信息。
...
请您阅读完整版《泡泡战士冒险用户协议》及《泡泡战士冒险隐私政策》了解详细信息。
如您同意《泡泡战士冒险用户协议》及《泡泡战士冒险隐私政策》，请您点击“允许”开始使用我们的产品和服务，我们将尽全力保护您的个人信息安全。
...
泡萌游戏（注册地址：暂无，以下简称“我们”）系移动应用程序“泡泡战士冒险”（以下简称“泡泡战士冒险”）的运营者。我们非常重视保护用户（以下简称“您”）的个人信息和隐私。您在使用泡泡战士冒险时，我们会收集、使用、保存、共享您的相关个人信息。为呈现我们处理您个人信息的情况，我们特制定《泡泡战士冒险隐私政策》（以下简称“隐私政策”），我们承诺严格按照本隐私政策处理您的个人信息。
我们在此提醒您：
在您使用泡泡战士冒险前，请您务必认真阅读本隐私政策，充分理解各条款内容，包括但不限于免除或限制我们责任的条款。您知晓并确认，您勾选“同意”本隐私政策并使用泡泡战士冒险，就表示您同意我们按照本隐私政策处理您的个人信息。请您知悉，本政策仅适用于我们通过泡泡战士冒险向您提供服务所收集的信息，不适用于通过接入泡泡战士冒险以向您提供产品或服务的第三方所收集的信息。
...
一、我们如何收集和使用您的个人信息
（一）我们如何收集您的个人信息
在您使用泡泡战士冒险过程中，我们会按照如下方式收集您的个人信息：
1.完成注册
当您注册泡泡战士冒险账户时，我们需要收集您的手机号码、登录密码、【数据类型】。我们收集您的上述信息是为了帮助您完成泡泡战士冒险账户的注册，保护您的账户安全，如您不提供这类信息，我们将无法为您创建账户并正常向您提供服务。
2.游戏服务
...
3.实名认证
当您进行实名认证时，我们需要收集您的姓名、身份证件类型、身份证件号码、【数据类型】。同时，为实现实名认证的目的，您同意并授权我们自行或委托第三方向有关实名认证机构（如个人征信机构、政府部门等）提供、查询、核对您的前述身份信息。我们收集您的上述信息是为了履行法定义务，核验用户真实身份、识别用户年龄以及保障系统和服务安全。如您不提供这类信息，您将无法登录泡泡战士冒险或在使用泡泡战士冒险过程中受到相应限制。
4.保障网络和服务的安全
...
（二）设备权限调用情况
在您使用泡泡战士冒险过程中，我们需要在必要范围内向您申请获取设备权限。请您知悉，我们不会默认开启您设备的权限，仅在您主动确认开启的情况下，泡泡战士冒险才有可能通过设备权限收集您的信息。泡泡战士冒险调用的权限、调用权限的目的，以及调用权限前向您询问的情况请见下表：
...
七、您如何管理您的个人信息
在您使用泡泡战士冒险期间，您可以通过相应页面提示或本隐私政策载明的方式联系我们，以访问、更正、删除您的个人信息，以及行使改变授权同意的范围与注销账号的权利，您的意见会及时得到处理。
1.访问及更正您的个人信息
...
请您理解，泡泡战士冒险可能需要开启部分权限并收集必要的个人信息才能得以实现。当您撤回您的同意时，我们将无法继续为您提供撤回同意所对应的服务，但不会影响此前基于您的授权而开展的个人信息处理服务。
4.注销账户
